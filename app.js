...
// //1
// let mas = [1, 2, 3, 5, 8, 9, 10];
// let newMas = mas.map((value) => ({
//    digit: value,
//    odd: Boolean(value % 2),
// }));
...
// let isSomeZero = arr.some((num) => num === 0);

// //3
// arr = ['yes', 'hello', 'no', 'easycode', 'what'];
// let arrLength = arr.every((str) => str.length >= 3);
...
// function sortProducts(arr, min, max) {
//    return arr
...
// console.log(calcModul.setValue(3).pow(2).getValue());
